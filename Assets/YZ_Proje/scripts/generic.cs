...

{
    ...
    public const int CHROMOSOME_SIZE = 30;
...

            {
...

                {
...

                    {
                        ...
                        else if (pop.getChromozom()[i].getGenes()[j] == 1) { x.transform.Rotate(new Vector3(0, 1, 0)); }

                        else if (pop.getChromozom()[i].getGenes()[j] == 2) { x.transform.Rotate(new Vector3(0, -1, 0)); }
